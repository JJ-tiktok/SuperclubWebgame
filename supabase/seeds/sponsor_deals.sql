...
insert into public.sponsor_deals (
  ...
  ('amt_denkmalschutz', 'newly_promoted', 'Amt für Denkmalschutz', 'Baue das Stadion für 3 Saisons nicht aus', 'Das städtische Amt für Denkmalschutz möchte die Kriegsüberreste erhalten.', 'no_stadium_upgrade', '{}'::jsonb, 3, 'stadium_rebuild', '{"stadium_level":2,"status_delta":1,"status_seasons":1}'::jsonb, 6),
  ...
  ('kinoy_to', 'established', 'Kinoy.To', 'Keine Simulation endet unentschieden', 'Deine Spiele werden live verfilmt.', 'no_draws', '{}'::jsonb, 1, 'money', '{"amount":50000000}'::jsonb, 4),
